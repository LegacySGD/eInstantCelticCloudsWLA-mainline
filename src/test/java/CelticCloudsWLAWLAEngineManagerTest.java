...
public class CelticCloudsWLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(CelticCloudsWLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/CelticCloudsWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/CelticCloudsWLAIW/InitOutcome.xml").getDocumentElement();
